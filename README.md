...
### 3. docker exec - รันคำสั่งใน Container
...
### 6. docker stop/start/restart - ควบคุมสถานะ Container
...
### 7. docker logs - ดู Logs ของ Container
...
### 9. docker cp - คัดลอกไฟล์ระหว่าง Container และ Host
